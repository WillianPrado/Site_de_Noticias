			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Atualizar Etinia</h4>
					</div>
						<label>Etinia</label>
		...
		$(document).ready(function(){
			...
			$('#btnAdicionarCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:dados,
					url:"../procedimentos/etinia/adicionarCategorias.php",
					success:function(r){
						alert(r);
						if(r==1){
					//limpar formulário
		...
		$(document).ready(function(){
			$('#btnAtualizaCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:dados,
					url:"../procedimentos/etinia/atualizarCategorias.php",
					success:function(r){
						alert(r);
						if(r==1){
							$('#tabelaCategoriaLoad').load("etinia/etinia.php");
		...
		function eliminaCategoria(idcategoria){
			alertify.confirm('Deseja excluir esta categoria?', function(){ 
				$.ajax({
					...
					url:"../procedimentos/etinia/eliminarCategorias.php",
					success:function(r){
						if(r==1){
							$('#tabelaCategoriaLoad').load("etinia/etinia.php");
