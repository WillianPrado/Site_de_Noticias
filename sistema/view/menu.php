        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a id="noticias" href="noticias.php">noticias</a></li>
              <li><a href="categorias.php">estado</a></li>
              <li><a href="etinia.php">etinia</a></li>
              <li><a href="tiposDecaso.php">Tipos de caso</a></li>
            </ul>
          </li>      
